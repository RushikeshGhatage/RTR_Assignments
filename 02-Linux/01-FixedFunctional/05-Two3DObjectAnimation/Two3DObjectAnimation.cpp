...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay, gWindow, "Rushikesh Vinod Ghatage : Two 3D Object Animation");
...
void Draw(void)
{
	...
	glRotatef(TAngle_rvg, 0.0f, 1.0f, 0.0f);
	glBegin(GL_TRIANGLES);		//Front Plane
		glColor3f(1.0f, 0.0f, 0.0f);	//Red
		glVertex3f(0.0f, 0.75f, 0.00f);
	...
	glRotatef(RAngle_rvg, 1.0f, 0.0f, 0.0f);
