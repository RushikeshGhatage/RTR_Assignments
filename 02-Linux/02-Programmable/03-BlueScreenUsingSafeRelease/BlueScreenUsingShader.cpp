...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay_rvg, gWindow_rvg, "Rushikesh Vinod Ghatage : Bluescreen Using Shader");
...
void Initialize(void)
{
	...
	fprintf(gpFile_rvg, "Vertex Shader Compilation done Successfully.\n");
	...
	fprintf(gpFile_rvg, "Fragment Shader Compilation done Successfully.\n");
	...
	//3)Then, Link all those attached Shader at once.
	glLinkProgram(gShaderProgramObject_rvg);	//Here there should be Shader Linkage Error Checking
	fprintf(gpFile_rvg, "Shader Program Object Compilation done Successfully.\n");
