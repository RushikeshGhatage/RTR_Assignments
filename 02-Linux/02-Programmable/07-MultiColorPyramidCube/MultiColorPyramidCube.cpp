...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay_rvg, gWindow_rvg, "Rushikesh Vinod Ghatage : Multicolor Rotating Pyramid & Cube");
...
void Initialize(void)
{
	...
	const GLfloat pyramidColors_rvg[] = 
	{
	...
	const GLfloat squareColors_rvg[] = 
	{
		1.0f, 0.0f, 0.0f,	//Red 		//FRONT
		0.0f, 1.0f, 0.0f,	//Green
		0.0f, 0.0f, 1.0f,	//Blue
	...
	glBindVertexArray(vao_pyramid_rvg);
			...
			//Fill Data into Buffer Array
			glBufferData(GL_ARRAY_BUFFER, sizeof(pyramidColors_rvg), pyramidColors_rvg, GL_STATIC_DRAW);
	...
	glBindVertexArray(vao_cube_rvg);
			...
			//Fill Data into Buffer Array
			glBufferData(GL_ARRAY_BUFFER, sizeof(squareColors_rvg), squareColors_rvg, GL_STATIC_DRAW);
