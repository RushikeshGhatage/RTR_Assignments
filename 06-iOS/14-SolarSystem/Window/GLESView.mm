...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        [self makeSphereWithRadius:2.0f usingSlices:20 andStacks:20];
...
-(void)drawView
{
    ...
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        ...
        translateMatrix = vmath::translate(0.0f, 0.0f, -15.0f);
        ...
        [self pushMatrixWithMat4 : modelViewProjectionMatrix];
            ...
            //Draw Object
            glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, vbo_sphere_element_rvg);
            glDrawElements(GL_POINTS, numElements_rvg, GL_UNSIGNED_SHORT, 0);
            glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0);
...
-(void)onSingleTap:(UITapGestureRecognizer *)gr
{
    ...
    if (bTowardsSun == true)
    {
        year_rvg = (year_rvg + 15) % 360;
    }
    else
    {
        day_rvg = (day_rvg + 15) % 360;
    }
}
