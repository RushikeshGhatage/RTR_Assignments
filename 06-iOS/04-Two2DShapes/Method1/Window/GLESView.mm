...
@implementation GLESView
{
    ...
    GLuint vbo_square_color_rvg;               //Vertex Buffer Objects for Colors
...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        glBindVertexArray(vao_square_rvg);
                ...
                //Generate Buffer Array
                glGenBuffers(1, &vbo_square_color_rvg);
           
                //Bind Buffer Array
                glBindBuffer(GL_ARRAY_BUFFER, vbo_square_color_rvg);
...
-(void)dealloc
{
    ...
    [super dealloc];
        ...
        if (vbo_square_color_rvg)
        {
            glDeleteBuffers(1, &vbo_square_color_rvg);
            vbo_square_color_rvg = 0;
        }
