...
{
    //Code
    singleTapPressed_rvg++;
    if (singleTapPressed_rvg == 1)
    {
    ...
    else if (singleTapPressed_rvg == 2)
    {
        XKeyPressed_rvg = false;
    ...
    else if (singleTapPressed_rvg == 3)
    {
        XKeyPressed_rvg = false;
        YKeyPressed_rvg = false;
...
-(void)onDoubletap:(UITapGestureRecognizer *)gr
{
    ...
    {
        bLight_rvg = false;
        printf("Light is Disabled!\n");
    }
    else
    {
        bLight_rvg = true;
        printf("Light is Enabled!\n");
    }
}
