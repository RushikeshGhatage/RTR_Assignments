...
@implementation AppDelegate
    ...
    -(void)applicationDidFinishLaunching:(NSNotification *)aNotification
    {
        ...
        [window setTitle: @"RVG : macOS 3 Moving Lights on Sphere"];
        [window center];
...
@implementation MyOpenGLView
    {
        ...
        GLfloat lightAngle0_rvg;
        GLfloat lightAngle1_rvg;
        GLfloat lightAngle2_rvg;
    ...
    -(void)prepareOpenGL
    {
        ...
        lightAngle0_rvg = 0.0f;
        lightAngle1_rvg = 0.0f;
        lightAngle2_rvg = 0.0f;
        ...
        const GLchar *VertexShaderCode_pv_rvg =
                                        ...
                                        "{" \
                                            ...
                                            "fong_ads_light_pv = vec3(0.0f, 0.0f, 0.0f);" \
        ...
        const GLchar *FragmentShaderCode_pf_rvg =
                                    ...
                                    "{" \
                                        ...
                                        "vec3 fong_ads_light_pf = vec3(0.0f, 0.0f, 0.0f);" \
                                        ...
                                        "{" \
                                            ...
                                            "{" \
                                                ...
                                                "diffuse_pf[i] = u_ld_pf[i] * u_kd_pf * max(dot(normalized_light_direction_pf[i], normalized_tranformed_normal_pf), 0.0f);" \
                                                "specular_pf[i] = u_ls_pf[i] * u_ks_pf * pow(max(dot(reflection_vector_pf[i], normalized_view_vector_pf), 0.0f), u_materialShininess_pf);" \
    ...
    -(void)makeSphereWithRadius:(float)radius usingSlices:(int)slices andStacks:(int)stacks
    {
        //Local Variable Declaration
        float RVG_PI = 3.14159f;
        float drho_rvg = RVG_PI / (float)stacks;
        float dtheta_rvg = 2.0f * RVG_PI / (float)slices;
        ...
        //Code
        int iNumIndices = (maxElements_rvg / 3);
        ...
        glBindVertexArray(vao_sphere_rvg);
                ...
                glBufferData(GL_ARRAY_BUFFER, iNumIndices * 3 * sizeof(float), verts_rvg, GL_STATIC_DRAW);
                ...
                //Fill Data into Buffer Array
                glBufferData(GL_ARRAY_BUFFER, iNumIndices * 3 * sizeof(float), norms_rvg, GL_STATIC_DRAW);
                ...
                //Fill Data into Buffer Array
                glBufferData(GL_ARRAY_BUFFER, iNumIndices * 2 * sizeof(float), texCoords_rvg, GL_STATIC_DRAW);
                ...
                //Fill Data into Buffer Array
                glBufferData(GL_ELEMENT_ARRAY_BUFFER, iNumIndices * 3 * sizeof(short), elements_rvg, GL_STATIC_DRAW);
    ...
    -(void)updateView
    {
        ...
        if (bLight_rvg == true)
        {
            lightAngle0_rvg += 0.025f;
            lightAngle1_rvg += 0.025f;
            lightAngle2_rvg += 0.025f;
