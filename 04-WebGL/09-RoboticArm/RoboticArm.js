...
function keyDown(event)
{
	switch(event.keyCode)
	{
		...
		case 83: 	//S or s
			Shoulder_rvg = (Shoulder_rvg + 3) % 360;
		break;
...
function draw()
{
	...
	mat4.translate(modelViewProjectionMatrix, modelViewProjectionMatrix, [0.0, 0.0, -10.0]);
	mat4.rotateZ(modelViewProjectionMatrix, modelViewProjectionMatrix, degToRad(Shoulder_rvg));

	pushMatrix_rvg();
		mat4.translate(modelViewProjectionMatrix, modelViewProjectionMatrix, [1.0, 0.0, 0.0]);

		pushMatrix_rvg();
			mat4.scale(modelViewProjectionMatrix, modelViewProjectionMatrix, [0.8, 0.2, 1.0]);
			...
			gl.vertexAttrib3f(WebGLMacros.RVG_ATTRIBUTE_COLOR, 0.5, 0.35, 0.05);
		...
		mat4.rotateZ(modelViewProjectionMatrix, modelViewProjectionMatrix, degToRad(Elbow_rvg));
		
		mat4.translate(modelViewProjectionMatrix, modelViewProjectionMatrix, [1.2, 0.0, 0.0]);
