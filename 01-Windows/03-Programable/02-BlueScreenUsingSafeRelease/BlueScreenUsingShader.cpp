...
void Initialize(void)
{
	...
	//OpenGL related Log
	fprintf(gpFile_rvg, "\nOpenGL Related Logs\n\n");
	fprintf(gpFile_rvg, "OepnGL Vendor : %s\n", glGetString(GL_VENDOR));
	...
	//Compile Shader
	glCompileShader(gVertexShaderObject);	//Here there should be Shader Compilation Error Checking
	...
	//Compile Shader
	glCompileShader(gFragmentShaderObject);	//Here there should be Shader Compilation Error Checking
	...
	glLinkProgram(gShaderProgramObject);	//Here there should be Shader Linkage Error Checking
