...
void Initialize(void)
{
	...
	const GLchar *VertexShaderCode = 
									...
									"{"	\
										...
										"float size = (45.0 * newVertex.z * newVertex.z);" \
	...
	for (int i = 0; i < NUM_STARS; i++)
	{
		...
		star[i].fragColor[0] = 1.0f;
		star[i].fragColor[1] = 1.0f;
		star[i].fragColor[2] = 1.0f;
	}
...
void Display(void)
{
	...
	translateMatrix = vmath::translate(0.0f, -50.0f, -5.0f);
