...
{
	//Local Variable Declaration
	static GLfloat TAngle_rvg = 0.0f;
	...
	glRotatef(TAngle_rvg, 0.0, 1.0, 0.0);

	glBegin(GL_TRIANGLES);		//Front Plane
	glVertex3f(0.0f, 0.75f, 0.00f);			//O

	glColor3f(1.0f, 0.0f, 0.0f);	//Red
	glVertex3f(0.5f, -0.25f, 0.5f);			//A

	glColor3f(0.0f, 1.0f, 0.0f);	//Green
	glVertex3f(-0.5f, -0.25f, 0.5f);		//B
	glEnd();
	...
	glVertex3f(0.5f, -0.25f, -0.5f);		//D

	glColor3f(0.0f, 0.0f, 1.0f);	//Blue
	glVertex3f(-0.5f, -0.25f, -0.5f);		//C
	glEnd();
