...
GLuint Stone_Texture_rvg;
GLuint Kundali_Texture_rvg;
...
void Initialize(void)
{
	...
	//Load Texture
	loadGLTexture(&Stone_Texture_rvg, MAKEINTRESOURCE(STONE_BITMAP));
	loadGLTexture(&Kundali_Texture_rvg, MAKEINTRESOURCE(KUNDALI_BITMAP));
...
void Display(void)
{
	...
	////////////////////////////// PYRAMID //////////////////////////////
	glBindTexture(GL_TEXTURE_2D, Stone_Texture_rvg);
	glBegin(GL_TRIANGLES);		//Front Plane
	glTexCoord2f(0.5f, 1.0f);
	glVertex3f(0.0f, 1.0f, 0.00f);		//O
	...
	glTranslatef(1.5f, 0.0f, -5.0f);
	glRotatef(Angle_rvg, 1.0, 0.0, 0.0);

	////////////////////////////// CUBE //////////////////////////////
	glRotatef(Angle_rvg, 1.0, 0.0, 0.0);
	glRotatef(Angle_rvg, 0.0, 1.0, 0.0);
	glRotatef(Angle_rvg, 0.0, 0.0, 1.0);

	glBindTexture(GL_TEXTURE_2D, Kundali_Texture_rvg);
...
void Uninitialize()
{
	...
	if (Stone_Texture_rvg)
	{
		glDeleteTextures(1, &Stone_Texture_rvg);	
	}
	
	if (Kundali_Texture_rvg)
	{
		glDeleteTextures(1, &Kundali_Texture_rvg);
	}
