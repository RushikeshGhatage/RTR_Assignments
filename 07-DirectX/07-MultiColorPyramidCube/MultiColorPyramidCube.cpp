...
#define WIN_NAME "DirectX : Multi Color Pyramid Cube"
...
ID3D11Buffer *gpID3D11Buffer_VertexBuffer_Pyramid_Color_rvg = NULL;

ID3D11Buffer *gpID3D11Buffer_VertexBuffer_Cube_Position_rvg = NULL;
ID3D11Buffer *gpID3D11Buffer_VertexBuffer_Cube_Color_rvg = NULL;
...
HRESULT initialize(void)
{
	...
	//Initialize and Create Vertex Buffer
	ZeroMemory((void *)&bufferDesc_rvg, sizeof(D3D11_BUFFER_DESC));
	bufferDesc_rvg.ByteWidth = sizeof(float) * ARRAYSIZE(pyramidColors_rvg);
	bufferDesc_rvg.BindFlags = D3D11_BIND_VERTEX_BUFFER;
	bufferDesc_rvg.CPUAccessFlags = D3D11_CPU_ACCESS_WRITE;
	bufferDesc_rvg.Usage = D3D11_USAGE_DYNAMIC;
	...
	hr_rvg = gpID3D11Device_rvg->CreateBuffer(&bufferDesc_rvg,
												NULL,
												&gpID3D11Buffer_VertexBuffer_Pyramid_Color_rvg);

	if (FAILED(hr_rvg))
	{
		fopen_s(&gpFile_rvg, gszLogFileName_rvg, "a+");
		fprintf_s(gpFile_rvg, "ID3D11Device::CreateBuffer() Failed for Color of Pyramid Vertex Buffer!\n");
		fclose(gpFile_rvg);
		return(hr_rvg);
	}
	...
	{
		fopen_s(&gpFile_rvg, gszLogFileName_rvg, "a+");
		fprintf_s(gpFile_rvg, "ID3D11Device::CreateBuffer() Succeeded for Color of Pyramid Vertex Buffer!\n");
		fclose(gpFile_rvg);
	}

	//Copy Vertices into Buffer
	ZeroMemory((void *)&mappedSubresources_rvg, sizeof(D3D11_MAPPED_SUBRESOURCE));
	gpID3D11DeviceContext_rvg->Map(gpID3D11Buffer_VertexBuffer_Pyramid_Color_rvg,
									0,
									D3D11_MAP_WRITE_DISCARD,
									0,
									&mappedSubresources_rvg);

	memcpy(mappedSubresources_rvg.pData, pyramidColors_rvg, sizeof(pyramidColors_rvg));
	gpID3D11DeviceContext_rvg->Unmap(gpID3D11Buffer_VertexBuffer_Pyramid_Color_rvg, 0);
	...
	{
		fopen_s(&gpFile_rvg, gszLogFileName_rvg, "a+");
		fprintf_s(gpFile_rvg, "ID3D11Device::CreateBuffer() Failed for Color of Pyramid Constant Buffer!\n\n");
		fclose(gpFile_rvg);
		return(hr_rvg);
	}
	...
	{
		fopen_s(&gpFile_rvg, gszLogFileName_rvg, "a+");
		fprintf_s(gpFile_rvg, "ID3D11Device::CreateBuffer() Succeeded for Color of Pyramid Constant Buffer!\n\n");
		fclose(gpFile_rvg);
	}
	...
	//Initialize and Create Vertex Buffer
	ZeroMemory((void *)&bufferDesc_rvg, sizeof(D3D11_BUFFER_DESC));
	bufferDesc_rvg.ByteWidth = sizeof(float) * ARRAYSIZE(cubeColors_rvg);
	bufferDesc_rvg.BindFlags = D3D11_BIND_VERTEX_BUFFER;
	bufferDesc_rvg.CPUAccessFlags = D3D11_CPU_ACCESS_WRITE;
	bufferDesc_rvg.Usage = D3D11_USAGE_DYNAMIC;
	...
	hr_rvg = gpID3D11Device_rvg->CreateBuffer(&bufferDesc_rvg,
												NULL,
												&gpID3D11Buffer_VertexBuffer_Cube_Color_rvg);

	if (FAILED(hr_rvg))
	{
		fopen_s(&gpFile_rvg, gszLogFileName_rvg, "a+");
		fprintf_s(gpFile_rvg, "ID3D11Device::CreateBuffer() Failed for Color of Cube Vertex Buffer!\n");
		fclose(gpFile_rvg);
		return(hr_rvg);
	}
	...
	{
		fopen_s(&gpFile_rvg, gszLogFileName_rvg, "a+");
		fprintf_s(gpFile_rvg, "ID3D11Device::CreateBuffer() Succeeded for Color of Cube Vertex Buffer!\n");
		fclose(gpFile_rvg);
	}

	//Copy Vertices into Buffer
	ZeroMemory((void *)&mappedSubresources_rvg, sizeof(D3D11_MAPPED_SUBRESOURCE));
	gpID3D11DeviceContext_rvg->Map(gpID3D11Buffer_VertexBuffer_Cube_Color_rvg,
									0,
									D3D11_MAP_WRITE_DISCARD,
									0,
									&mappedSubresources_rvg);

	memcpy(mappedSubresources_rvg.pData, cubeColors_rvg, sizeof(cubeColors_rvg));
	gpID3D11DeviceContext_rvg->Unmap(gpID3D11Buffer_VertexBuffer_Cube_Color_rvg, 0);
	...
	{
		fopen_s(&gpFile_rvg, gszLogFileName_rvg, "a+");
		fprintf_s(gpFile_rvg, "ID3D11Device::CreateBuffer() Failed for Color of Cube Constant Buffer!\n\n");
		fclose(gpFile_rvg);
		return(hr_rvg);
	}
	...
	{
		fopen_s(&gpFile_rvg, gszLogFileName_rvg, "a+");
		fprintf_s(gpFile_rvg, "ID3D11Device::CreateBuffer() Succeeded for Color of Cube Constant Buffer!\n\n");
		fclose(gpFile_rvg);
	}
...
void display(void)
{
	...
	offset_rvg = 0;
	gpID3D11DeviceContext_rvg->IASetVertexBuffers(1, 1, &gpID3D11Buffer_VertexBuffer_Pyramid_Color_rvg, &stride_rvg, &offset_rvg);
	...
	stride_rvg = sizeof(float) * 3;
	offset_rvg = 0;
	gpID3D11DeviceContext_rvg->IASetVertexBuffers(1, 1, &gpID3D11Buffer_VertexBuffer_Cube_Color_rvg, &stride_rvg, &offset_rvg);
...
void uninitialize(void)
{
	...
	if (gpID3D11Buffer_VertexBuffer_Pyramid_Color_rvg)
	{
		gpID3D11Buffer_VertexBuffer_Pyramid_Color_rvg->Release();
		gpID3D11Buffer_VertexBuffer_Pyramid_Color_rvg = NULL;
	}	
	...
	if (gpID3D11Buffer_VertexBuffer_Cube_Color_rvg)
	{
		gpID3D11Buffer_VertexBuffer_Cube_Color_rvg->Release();
		gpID3D11Buffer_VertexBuffer_Cube_Color_rvg = NULL;
	}		
